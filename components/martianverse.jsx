                ...
                <>
                    <div className="container mx-auto py-10 md:py-20">
                        ...
                        <div className="md:pt-10">
                            <div className="text-white md:space-y-5 mx-10 my-10" style={{textAlign:"start"}}>
                                <h2 className="text-[20px] md:text-[40px]">
                                    Enter The
                                </h2>
                                <h1 className="heading text-[24px] md:text-[56px] uppercase">
                                    Martian<span className="text-red-500">
                                        Verse
                                    </span>
                                </h1>
                            </div>
                            <div className="flex justify-center">
                                <div className="martianverseCard rounded-[14px] md:rounded-[32px] w-[327px] h-[486px] md:w-[1200px] md:h-[1512px]">
                                    <div className="martianverseOverlay rounded-[14px] md:rounded-[32px] w-[327px] h-[486px] md:w-[1200px] md:h-[1512px] flex flex-col justify-end">
                                        <hr className="mx-5 md:mx-10 w-40 md:w-80 border-2" />
                                        <p className="m-5 md:m-10 text-[11px] md:text-[18px] text-white">
                                            Explore the MartianVerse and it’s <b>open world experience.</b>
                                            This is where your Avatars come to life. You can choose to battle
                                            other players in the <b>Battle Arena</b>, race in the <b>Dirt Tracks</b> or
                                            terraform your land plot to build whatever you like. Wishing to
                                            socialise? Come hangout at one of the communal spaces and meet other
                                            players. You can also wandering in the <b>Outer Lands</b> to discover rare
                                            elements & fossils to trade in the <b>MarketPlace.</b>
                                        </p>
                            ...
                            <div className="martianverseCard">
                                <div className="martianverseOverlay flex flex-col justify-end items-end">
                                    <p className="mx-10 text-2xl text-white my-10">
                                        Explore the MartianVerse and it’s open world experience.
                                        This is where your Avatars come to life. You can choose to battle
                                        other players in the Battle Arena, race in the Dirt Tracks or
                                        terraform your land plot to build whatever you like. Wishing to
                                        socialise? Come hangout at one of the communal spaces and meet other
                                        players. You can also wandering in the Outer Lands to discover rare
                                        elements & fossils to trade in the MarketPlace.
                                    </p>
                                </div>
                            </div>
                        </div>
