          ...
          <div className="container mx-auto my-28">
            <div className="flex justify-center my-24">
              <iframe
                width="1000"
                height="650"
                src="https://www.youtube.com/embed/20NBwWJ8nno?si=LrwoeYdX5xh4I5ZJ"
                title="Red Astro Wars ($RAW) - Marketplace"
                frameborder="0"
              ...
              <div className="flex flex-col space-y-24 mt-36 pl-24 pt-24 w-2/3">
                <div className="w-full space-y-7 flex flex-col items-start">
                  ...
                  <p className="text-left text-white text-xl">
                    The in-game currency of the MartianVerse can be acquired by
                    winning in the Battle Arena or Rover Racing, staking your
                    $RAW, looting the RedBox or trading in the MarketPlace.
                  </p>
                </div>
              </div>
              <div className="flex">
